...
void HelpScreenState::makeText()
{
    ...
    walkText.addComponent<TransformComponent>(10, 120, 80, 640, 1);
    ...
    shieldText.addComponent<TransformComponent>(10, 220, 80, 640, 1);
    ...
    mouseText.addComponent<TransformComponent>(10, 320, 80, 640, 1);
