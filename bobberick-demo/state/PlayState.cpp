...
bool PlayState::onEnter()
{
	...
	auto& spriteComponent = player->addComponent<SpriteComponent>("assets/image/character/character.png", "character",
	                                                              6, 4, 5);
	...
	TilesetComponent* tilesetComponent = levelFactory->Load("assets/maps/map1.tmx",
	...
	// const auto collisionComponent = new CollisionComponent("fire", 140, 175, 40);
	// CollisionComponent collisionComponent{"fire", 140, 175, 40};
	box->addExistingComponent<CollisionComponent>(new CollisionComponent("fire", 140, 175, 40));
	...
	const auto exitButtonComponent = new ButtonComponent([this]()
	{
