...
void BobberGame::preloadTextures()
{
	...
	t.load("assets/image/Enemies/blood1.png", "blood1", renderer);
	t.load("assets/image/Enemies/blood2.png", "blood2", renderer);
	t.load("assets/image/Enemies/blood3.png", "blood3", renderer);
	t.load("assets/image/Enemies/blood4.png", "blood4", renderer);
	t.load("assets/image/Enemies/blood5.png", "blood5", renderer);
